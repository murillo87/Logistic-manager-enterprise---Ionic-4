...
@Component({
  selector: 'app-operador-enproceso',
  templateUrl: './operador-enproceso.page.html',
  styleUrls: ['./operador-enproceso.page.scss'],
})
export class OperadorEnprocesoPage implements OnInit {                                                                                                                                                                                            
