...
@Component({
  selector: 'app-existencia-mercancia',
  templateUrl: './existencia-mercancia.page.html',
  styleUrls: ['./existencia-mercancia.page.scss'],
})
export class ExistenciaMercanciaPage implements OnInit {
  ...
  ngOnInit() {
    ...
    Promise.all([this.storage.get('name_tkn'), this.storage.get('id_user')]).then(values => {
      ...
      let headers = new HttpHeaders({
        ...
        try {
          this.http.post(environment.url_site+'serviciosLogisticos/existenciaMercancia', 
